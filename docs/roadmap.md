...
the approved next checkpoint. Its D17.0 falsification studies plus D17.2/D17.3
test-only ownership/private-runtime and grammar models, and the dormant
onboarding-phase contract, are in progress; no D17 user-facing behavior,
schema migration, or provider launch path is implemented yet.
...
D17.2/D17.3 test-only ownership/private-runtime and grammar models, plus a
dormant onboarding-phase contract, have begun. No D17 user-facing behavior,
